...
file_dir = os.path.dirname('/graph_parser_minting.py')
sys.path.append(file_dir)

from graph_parser_minting import *
...
print("Made it past the hard part")
...
anat_file = opj( 'sub-{subject_id}_t1w_preproc.nii.gz')
func_file = opj('sub-{subject_id}_ses-test_task-{task_name}_bold.nii.gz')
...
wf = preproc.run('MultiProc', plugin_args={'n_procs': 8})
#print(parse(wf))
